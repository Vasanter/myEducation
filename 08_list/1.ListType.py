...
# Гибкость: В одном списке могут быть элементы разных типов, включая вложенные списки


# my_list = list()
# print(my_list)  # Outputs: [] - пустой список
...
# squares = [x**2 for x in range(5)]  # генерируем список от 0 до 4 во второй степени
# print(squares)  # [0, 1, 4, 9, 16]


# my_list = [1, "apple", True, 1.5, [1, 2, 3]]
# print(my_list)  # Outputs:  [1, "apple", True, 1.5, [1, 2, 3] - списки могут содержать элементы любого типа
