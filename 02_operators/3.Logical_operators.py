...
# x = 5
# y = 8
# print(x > 1 and y < 10)  # Вернёт: True, потому что 5 больше 1 и 8 меньше 10.
...
# x = 5
# y = 8
# print(not (x > 1 and y < 10))  # Вернёт: False, т.к. 5 больше 1 и y меньше 10, но оператор not инвертирует значение.
