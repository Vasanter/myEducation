...
file = open(r'C:\Automation\myEducation\15_job_with_files\persons.csv', 'w')
csv_writer = csv.writer(file)
csv_writer.writerows(rows)
file.close()

file = open(r'C:\Automation\myEducation\15_job_with_files\persons.csv', 'r')
csv_dict_reader = csv.DictReader(file)
for row in csv_dict_reader:
    print(row['name'], row['age'], row['occupation'])
file.close()

file = open(r'C:\Automation\myEducation\15_job_with_files\persons.csv', 'a')
persons = [
