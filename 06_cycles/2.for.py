...
#     print(student)
#     for char in student:  # вложенный цикл. Не рекомендуется делать больше одного вложенного цикла
#         print(char)
...
#         counter += 1
#
# print('Count:', counter)  # Count: 3 т.к. 'l' встречается три раза в 'Hello World!'
