...
# set1 = {1, 2, 4, 8, 7}
# set2 = {3, 4, 5, 1, 9}
# print(set1 & set2)  # {1, 4} - проверка пересечения объектов во множествах (вариант 1)
# print(set1.intersection(set2))  # ...(вариант 2)


# set1 = {1, 2, 4, 8, 7}
# set2 = {3, 4, 5, 1, 9}
#
# print(set1.union(set2))  # {1, 2, 3, 4, 5, 9} - объединяем списки (вариант 1)
# print(set1 | set2)  # {1, 2, 3, 4, 5, 9} - ...(вариант 2)
...
# set1 = {1, 2, 4, 8, 7}
# set2 = {3, 4, 5, 1, 9}
# print(set1 ^ set2)  # {2, 3, 5, 7, 8, 9} - симметрическая разность
